...
public class FrmCommodityAdd extends JFrame implements ActionListener{
	public FreshCategory category=null;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btconfirm){
			...
			SXCSUtil.commodityManager.addCommodity(commodity, price, vipprice, commodityspec,commoditydesc,category);
