...
public class Recommended {
	private int rec_commodity_id;
	private int rec_menu_id;
	private String rec_describe;
	public int getRec_commodity_id() {
		return rec_commodity_id;
	}
	public void setRec_commodity_id(int rec_commodity_id) {
		this.rec_commodity_id = rec_commodity_id;
	}
