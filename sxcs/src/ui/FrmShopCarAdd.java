...
public class FrmShopCarAdd extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmShopCarAdd frame = new FrmShopCarAdd();
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == this.button) {
			...
			try {
				...
				SXCSUtil.userManager.addUserShopcar(sum, commodity);
